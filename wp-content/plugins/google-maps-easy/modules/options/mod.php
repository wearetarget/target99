		...
		if(empty($this->_options)) {
			$this->_options = dispatcherGmp::applyFilters('optionsDefine', array(
				'general' => array(
					...
					'opts' => array(
						'user_api_key' => array('label' => __('User API key', GMP_LANG_CODE), 'desc' => __('You can use your own Google API key, check the &lt;a href=&quot;//supsystic.com/google-maps-api-key/&quot; target=&quot;_blank&quot;&gt;instruction&lt;/a&gt; how to create it. To use plugin\'s default API key leave this field blank.', GMP_LANG_CODE), 'def' => '', 'html' => 'text'),
						...
						'access_roles' => array('label' => __('User role can use plugin', GMP_LANG_CODE), 'desc' => __('User with next roles will have access to whole plugin from admin area.', GMP_LANG_CODE), 'def' => 'administrator', 'html' => 'selectlist', 'options' => array($this, 'getAvailableUserRolesSelect'), 'pro' => ''),
					),
				),
			));
